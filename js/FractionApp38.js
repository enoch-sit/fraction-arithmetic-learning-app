...
let bar2NumberLineHidden = false;
let hideBar2NumberLineTimer = null;

function clearHideBar2NumberLineTimer() {
    if (hideBar2NumberLineTimer) {
        clearTimeout(hideBar2NumberLineTimer);
        hideBar2NumberLineTimer = null;
    }
}

function hideBar2NumberLine() {
    bar2NumberLineHidden = true;
    hideBar2NumberLineTimer = null;
...
function renderBar(num, action = 'none', old_s = 1) {
    ...
    if(nlWrap) {
        const showThisNL = showNL && (num === 1 || !bar2NumberLineHidden);
        if (showThisNL) {
...
function checkCommonDenom() {
    ...
    if (isCommonDenomReady) {
        ...
        clearHideBar2NumberLineTimer();
        hideBar2NumberLineTimer = setTimeout(hideBar2NumberLine, 1500 / currentSpeed);
